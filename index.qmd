...
Following Rykiel (1996), the objective of the classification model was not to achieve perfect prediction but to evaluate whether activity categories exhibit recognizable spatial and temporal patterns. The model was therefore assessed according to its intended purpose rather than against an expectation of complete behavioural prediction.
